...
const TABS = ["Geral", "Notificações", "Usuários", "Plano e cobrança", "Preferências"];
      ...
      {tab === "Plano e cobrança" && (
        <div className="grid grid-2">
          <div className="card section-block">
            ...
            <button className="btn" style={{ width: "100%", justifyContent: "center", marginTop: 14 }} onClick={() => toast("Redirecionando para o portal de cobrança…")}>
              Gerenciar plano
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-2">
          <div className="card section-block">
            ...
            <button
              className="btn btn-primary"
              style={{ width: "100%", justifyContent: "center", marginTop: 14 }}
              onClick={() => toast("Preferências salvas.")}
            >
              Salvar preferências
            </button>
          </div>
